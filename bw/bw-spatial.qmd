...
```{r}
#| echo: false
#| fig-cap: "A map of Seattle, Washington with highlighted locations of varying significance by Ashlyn R."
#| fig-alt: "A map that zooms in and focuses on an area of Seattle, Washington, United States. The map has points of three different colors which denote the feeling that is associated with those locations. The points are labelled with the name of what they represent. The location data came from: https://support.google.com/maps/answer/18539?hl=en&co=GENIE.Platform%3DDesktop."
...
flyTo(
  ...
  addLegend("bottomright", pal = factpal, values = ~feeling, title = "How I feel about them?")
