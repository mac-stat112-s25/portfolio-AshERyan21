...
# What did this code do?
 elections_small |> 
   ...
   head()
#created a new diff in 2020 variable
```
...
# What did this code do?
 elections_small |> 
   ...
   head()
#created a new variable that calculated the rounded total of republican votes
```
...
# What did this code do?
 elections_small |> 
   ...
   head()
#This created a true or false variable for whether or not the repub was greater than the dem
```
...
ggplot(mn_wi, aes(x = diff_dem_20, fill = state_name))+
  geom_density()
```
...
#provides the median republican %
```
...
#creates what appears a new variable with the median percentage
```
...
#creates the new median variable and shows the total votes across all of the counties
```
