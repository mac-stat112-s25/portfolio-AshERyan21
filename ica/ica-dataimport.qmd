...
```{r}
library(tidyverse)
imdb_messy <- read_csv("C:\\Users\\ashry\\OneDrive\\Documents\\GitHub\\portfolio-AshERyan21\\imdb_5000_messy.csv")
```
...
I am wondering if there are movies here in which there are no actors? Or if animated movies are counted? Or documentaries?
