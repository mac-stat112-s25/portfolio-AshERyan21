...
This is really hard to read. and the analyzing which states are similar and what general trends are is also harder. I think generally it aligns with the heat map?
...
I do not like this. But it does put into perspective where all the states are, allowing for comparison in relative geographic positioning. 
